                      ...
                      <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-8">
                          ...
                          <div class="form-group">
                            ...
                            <div class="box">
                              <input type="file" name="image" id="file-7" class="inputfile" accept="image/*" onchange="loadFile(event)" />
                          ...
                          <div class="form-group">
                            <label class="form-label">Images Header</label>
                            <div class="box">
                              <input type="file" name="image_detail" id="file-1" class="inputfile" accept="image/*" onchange="loadFile2(event)" />
