					...
					?>
						<article class="post post-large">
								...
								<div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
									<div>
										<div class="img-thumbnail">
											<img class="img-responsive" src="<?php echo base_url() ?>assets/uploads/news/<?php echo $key->id?>/<?php echo $key->images ?>" alt="<?php echo $key->title ?>" class="img-responsive">
							...
							<div class="post-content">
								...
								<h2><a href="<?php echo base_url()."news/detail/".$key->id."/".url_title($key->title) ?>"><?php echo $key->title; ?></a></h2>
