				...
				<div class="blog-posts single-post">
					...
					<article class="post post-large blog-single-post">
						<div class="post-image">
							<div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
								<div>
									...
									<img class="img-responsive" src="<?php echo base_url() ?>assets/uploads/news/<?php echo $data->id?>/<?php echo $data->images ?>" alt="<?php echo $data->title ?>" class="img-responsive">
						...
						<div class="post-content">
							...
							<h2><a href="<?php echo base_url()."news/detail/".$data->id."/".url_title($data->title) ?>"><?php echo $data->title; ?></a></h2>
